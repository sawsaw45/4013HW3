...
function selectWorkoutsByUser($wid) {
    try {
        ...
        $stmt = $conn->prepare("SELECT workoutid, username, workoutname, date, duration ,caloriesburned, userid FROM Workouts w join Users u on w.UserID = u.UserID WHERE u.userid=?; ");
